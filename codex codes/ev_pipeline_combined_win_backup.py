...
EXPECTED_CAPACITY_OPTIONS_AH = (104.5, 150, 300)  # Fleet pack capacities
...
PACK_USABLE_FRACTION = 0.95          # Usable fraction applied to nominal pack capacity
...
CONFIG_PROFILES = {
    'default': {
        ...
        'MIN_DELTA_SOC': 1.0,
        'MIN_AH': 1.0,
        'EXPECTED_CAPACITY_OPTIONS_AH': [104.5, 152.0, 304.0],
...
def _infer_pack_config_options(g: pd.DataFrame, q_anchor=np.nan, q_prev=np.nan):
    ...
    candidates = [
        ...
        {'series': 208, 'parallel': 1, 'nom_ah': 150.0},
        {'series': 208, 'parallel': 2, 'nom_ah': 300.0},
    ]
    scored = []
